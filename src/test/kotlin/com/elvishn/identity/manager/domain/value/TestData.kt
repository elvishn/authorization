...
object TestData {
    ...
    val OTP_STEP = AuthenticationStep(
    ...
    val CHECK_PHONE = AuthenticationStep(
    ...
    val IP_STEP = AuthenticationStep(
    ...
    val CHROME_MOBILE_CTX = Context(
        ip = IPv4.create("127.0.0.1"),
        userAgent = "Chrome/v1",
        device = Device.create("Pixel", "8 Pro"),
        phoneNumber = PhoneNumber("+8 800 555 35 35")
    )

    val ATTEMPT_V1 = AuthenticationAttempt(
        id = Id.generate(),
        ...
        expiresAt = Instant.MIN.plusSeconds(15_000)
    )
}
